/*
  # Seed Sample Data for EcoSmart Scanner

  1. Sample Products
    - Insert realistic Walmart products with environmental data
    - Include both eco-friendly and high-impact options
...
BEGIN
  ...
  VALUES (
    ...
    3,
    47.8,
    '{"voiceEnabled": true, "notifications": true, "dyslexiaMode": false}'
  )
  ...
  demo_user_id := 'demo-user-id-12345';
